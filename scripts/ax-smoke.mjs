...
const dryRunRequests = [
  ...
  call(205, "create-role", { name: "ax-probe-role", dryRun: true }),
  call(206, "update-role", { roleID: "role_ax_probe", description: "AX dry-run probe", dryRun: true }),
  call(207, "delete-role", { roleID: "role_ax_probe", dryRun: true }),
  call(208, "update-firewall-rules", { roleID: "role_ax_probe", firewallRules: [], dryRun: true }),
  call(209, "create-route", {
    networkID: "net_ax_probe",
    hostID: "host_ax_probe",
    network: "10.255.0.0/24",
    dryRun: true,
  }),
  call(210, "delete-route", { routeID: "route_ax_probe", dryRun: true }),
  call(211, "create-tag", { key: "ax", value: "probe", dryRun: true }),
  call(212, "update-tag", { tag: "ax:probe", description: "AX dry-run probe", dryRun: true }),
  call(213, "delete-tag", { tag: "ax:probe", dryRun: true }),
  call(214, "create-host-and-enrollment-code", {
    networkID: "net_ax_probe",
    name: "ax-probe-enroll-host",
    dryRun: true,
  }),
  call(215, "create-enrollment-code", { hostID: "host_ax_probe", dryRun: true }),
];
